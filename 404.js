...
(function(window) {
    ...
    var FuckAdBlock = function(options) {
        ...
        window.addEventListener(
            ...
            function() {
                setTimeout(function() {
                    if (self._options.checkOnLoad === true) self.check(false);
                }, 1);
            },
            false
        );
    ...
    FuckAdBlock.prototype = {
        ...
        on: function(detected, fn) {
            if (detected === false) this._var.triggers.push(fn);
            return this;
        },
    ...
    for (var field in fuck) {
        Object.defineProperty(fuck, field, {
            value: fuck[field],
            configurable: false,
        });
    }
    Object.defineProperties(window, {
        fuckAdBlock: { value: fuck, enumerable: true, writable: false },
    });
    Object.defineProperties(window, {
        blockAdBlock: { value: fuck, enumerable: true, writable: false },
    });
        ...
        for (word in words) {
            if (typeof word === 'string' && words.hasOwnProperty(word)) {
                ...
                if (userRegexp) {
                    ...
                    regexs.push(
                        new RegExp(
                            prepareRegex(word).replace(/\\?\*/g, function(
                                fullMatch
                            ) {
                                return fullMatch === '\\*' ? '*' : '[^ ]*';
                            }),
